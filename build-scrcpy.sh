...
echo "==================================="
echo "CastX Scrcpy Build Script"
echo "==================================="
...
echo ""
echo "Step 3: Building scrcpy binary..."
GO_BUILD_FLAGS="${GO_BUILD_FLAGS:-}"
$GO_BIN build $GO_BUILD_FLAGS -o bin/castx-scrcpy scrcpy.go

echo ""
echo "==================================="
echo "✓ Scrcpy build completed successfully!"
echo "==================================="
ls -lh bin/castx-scrcpy

echo ""
echo "Binary location: $PROJECT_DIR/bin/castx-scrcpy"
echo "To run: ./bin/castx-scrcpy"
echo ""
echo "Note: This requires:"
echo "  - ADB (Android Debug Bridge) installed"
echo "  - An Android device connected via USB or Wi-Fi"